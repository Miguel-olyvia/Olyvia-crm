      ...
      {pinos.length === 0 ? (
        <div className="p-6">
          <EmptyState
            ...
            description={
              semPonto > 0
                ? `Há ${semPonto} ${semPonto === 1 ? "ordem" : "ordens"} neste período, mas o local delas não tem ponto marcado. Marca-se na ficha do local, em Locais, com o GPS ou colando um link do Google Maps.`
