-- Re-applies 20261115130000's fix verbatim, after the throwaway
-- 20261115140000 temporarily restored the pre-fix behaviour to demonstrate
-- RED live against the remote (tests/e2e/contracts/*-scope-ownership.spec.ts).
-- Forward-only: 20261115140000 is not edited or deleted, this is a new file
-- that supersedes it. No further functional change versus 20261115130000.
