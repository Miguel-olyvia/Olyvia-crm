-- ============================================================
-- Preventive fix: fn_audit_quote_send (trigger on quote_sends) was
-- missing the standard app.audit_bypass guard, same category as
-- fn_audit_deal_child, fn_audit_proposal_send, fn_audit_proposal_verification.
-- No live business RPC currently writes to quote_sends under
-- app.audit_bypass=on, so this gap was dormant (confirmed via E2E
-- testing of the Orcamentos module), but fixed defensively so a
-- future atomic RPC cannot leak extra rows.
-- ============================================================
