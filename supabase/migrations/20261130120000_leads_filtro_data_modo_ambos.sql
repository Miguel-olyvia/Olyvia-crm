-- ============================================================================
-- Filtro de datas das leads: terceiro modo "criada E contactada no intervalo"
-- ============================================================================
--
-- Ja era possivel filtrar por data de criacao ou por data do ultimo contacto.
-- Faltava a pergunta "das que entraram neste periodo, quais ja foram
-- trabalhadas dentro dele" -- uma medida de resposta, nao de volume.
--
-- Acrescenta-se o modo 'ambos', que exige as DUAS datas dentro do intervalo.
-- Por ser uma interseccao devolve sempre menos linhas do que qualquer um dos
-- outros dois modos (medido na Mudelar desde 1 de Setembro: 229 criadas, 310
-- contactadas, 183 as duas coisas).
--
-- Os outros dois modos e a omissao ('created_at') ficam exactamente na mesma,
-- tal como os sete consumidores de get_scoped_leads_base que nao passam nada.
-- get_lead_status_counts ja repassa p_date_field, por isso os contadores dos
-- separadores acompanham sem alteracao.
