...
-- agendamento (em horas uteis).
--
-- Aditivo e desligado por omissao: scheduling_min_advance_hours nasce NULL
-- (sem restricao, comportamento identico ao que existia antes desta
-- migration). Nenhum formulario/campanha existente muda de comportamento
-- sem alguem ir la configurar.
--
