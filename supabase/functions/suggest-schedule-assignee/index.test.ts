 ...
 *       env-derived config (LOVABLE_API_KEY, rate-limit client) as `deps`;
...
Deno.test({
  name:
    ...
    "(SUPABASE_URL, SUPABASE_ANON_KEY/SERVICE_ROLE_KEY, LOVABLE_API_KEY) and a real Supabase client. " +
    ...
    "Supabase client(s) and LOVABLE_API_KEY via `deps`, then drive this scenario through that " +
