...
export function MembershipScopesDialog({
  ...
  const categoryLabelsPt: Record<string, string> = {
    ...
    deals: 'Pedidos de Proposta', proposals: 'Propostas', quotes: 'Orçamentos', contracts: 'Contratos', client_contracts: 'Contratos',
  ...
  const sidebarOrder = [
    ...
    'deals', 'proposals', 'quotes', 'contracts', 'client_contracts',
